...
# ---------------------------------------------------------------------------
# HTTPBearer is just a header-reader — it looks for "Authorization: Bearer <token>"
# in the incoming request and extracts the token string. It provides a simple
# Bearer Token input in the Swagger UI instead of a full OAuth2 form.
# ---------------------------------------------------------------------------
security = HTTPBearer()
